# Скрипт для обработки документов с использованием async SQLAlchemy
## 🌐 Обзор
...
3. **Перед запуском основгоно скрипта нужно запустить файла base_tz.py так как требовалась создать базу под тестовое задание** 
